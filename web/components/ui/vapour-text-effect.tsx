...
/**
 * VaporizeTextCycle — a canvas particle effect that renders text as particles,
 * then vaporizes it away (left-to-right or right-to-left), fades in the next
 * phrase, and loops. Used for the animated headline accents on the landing and
 * dashboard pages. Adapted from the provided vapour-text-effect design.
 */
