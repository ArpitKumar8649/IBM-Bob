 ...
 * themed to the Writers' Room rose palette. Adapted from the provided
 * sign-in-card-2 design.
 */
        ...
        >
          <div className="relative group">
            ...
            <div className="absolute -inset-[1px] rounded-2xl overflow-hidden">
              ...
              {/* Corner glow spots */}
              <motion.div
                className="absolute top-0 left-0 h-[5px] w-[5px] rounded-full bg-rose-200/40 blur-[1px]"
                animate={{ opacity: [0.2, 0.4, 0.2] }}
                transition={{ duration: 2, repeat: Infinity, repeatType: "mirror" }}
              />
              <motion.div
                className="absolute top-0 right-0 h-[8px] w-[8px] rounded-full bg-rose-200/60 blur-[2px]"
                animate={{ opacity: [0.2, 0.4, 0.2] }}
                transition={{ duration: 2.4, repeat: Infinity, repeatType: "mirror", delay: 0.5 }}
              />
              <motion.div
                className="absolute bottom-0 right-0 h-[8px] w-[8px] rounded-full bg-rose-200/60 blur-[2px]"
                animate={{ opacity: [0.2, 0.4, 0.2] }}
                transition={{ duration: 2.2, repeat: Infinity, repeatType: "mirror", delay: 1 }}
              />
              <motion.div
                className="absolute bottom-0 left-0 h-[5px] w-[5px] rounded-full bg-rose-200/40 blur-[1px]"
                animate={{ opacity: [0.2, 0.4, 0.2] }}
            ...
            <div className="relative bg-wine-900/60 backdrop-blur-xl rounded-2xl p-6 border border-rose-400/10 shadow-2xl overflow-hidden">
              ...
              <div className="text-center space-y-1 mb-5">
                ...
                >
                  Sign in to continue to The Writers&apos; Room
                </motion.p>
              </div>
              ...
              >
                ...
                <div className="flex items-center justify-between pt-1">
                  <div className="flex items-center space-x-2">
                    <div className="relative">
                      <input
                        ...
                        className="appearance-none h-4 w-4 rounded border border-rose-400/30 bg-rose-400/5 checked:bg-rose-500 checked:border-rose-500 focus:outline-none focus:ring-1 focus:ring-rose-400/40 transition-all duration-200"
                      />
                      {rememberMe && (
                        <motion.div
                    ...
                    <label
                      htmlFor="remember-me"
                      className="text-xs text-rose-100/60 hover:text-rose-100/80 transition-colors duration-200"
                    >
                      Remember me
                    </label>
                  </div>
                  ...
                  <div className="text-xs">
                    <Link
                      ...
                      className="text-rose-100/60 hover:text-rose-300 transition-colors duration-200"
                    >
                      Forgot password?
                    </Link>
                  </div>
                ...
                >
                  ...
                  <Link href="/signup" className="relative inline-block group/signup">
                    <span className="relative z-10 text-rose-300 group-hover/signup:text-rose-200 transition-colors duration-300 font-medium">
                      Sign up
                    </span>
                    <span className="absolute bottom-0 left-0 w-0 h-[1px] bg-rose-300 group-hover/signup:w-full transition-all duration-300" />
                  </Link>
                </motion.p>
              </form>
            </div>
